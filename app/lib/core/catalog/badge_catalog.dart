...
const List<BadgeDef> kBadges = [
  ...
  BadgeDef(key: 'logged_30', tier: 'silver', category: 'consistency', icon: '📈', criteriaType: 'days_logged', threshold: 100,
    title: {'ar': 'مواظب - ١٠٠ تسجيلة', 'en': 'Consistent - 100 Logs', 'fr': 'Assidu - 100 journaux'},
    description: {'ar': '١٠٠ يوم من المتابعة المنتظمة', 'en': '100 days of tracking.', 'fr': '100 jours de suivi.'}),
];
