...
const Map<String, HabitChecklists> kHabitChecklists = {
  ...
  'secret_habit': HabitChecklists(
    competingResponses: [
      ...
      {'ar': "أمسك الهاتف بيد واحدة وأشغل اليدين بوضوء بارد أو تمرين سريع", 'en': "Keep both hands busy with cold wudu or quick exercise instead of the phone", 'fr': "Occuper les deux mains avec des ablutions froides ou un exercice rapide au lieu du telephone"},
  ...
  'junk_food': HabitChecklists(
    competingResponses: [
      ...
      {'ar': "قلت بسم الله وذكّرت نفسي بأن خير وعاء يملؤه ابن آدم بطنه", 'en': "I said Bismillah and reminded myself that the stomach is the worst vessel to fill", 'fr': "J'ai dit Bismillah en me rappelant que le ventre est le pire récipient à remplir"},
    ],
    environment: [
  ...
  'bad_language': HabitChecklists(
    competingResponses: [
      {'ar': "عند اشتداد الغضب أقول أعوذ بالله من الشيطان الرجيم وأصمت فورا", 'en': "When anger rises, say I seek refuge in Allah from Satan and go silent at once", 'fr': "Quand la colere monte, dire je cherche refuge en Allah contre Satan et se taire aussitot"},
      {'ar': "أستبدل اللفظ البذيء بكلمة طيبة جاهزة مثل سبحان الله أو لا حول ولا قوة إلا بالله", 'en': "Replace the bad word with a ready good word like SubhanAllah or there is no power except by Allah", 'fr': "Remplacer le gros mot par une bonne parole prete comme SubhanAllah ou nulle force sauf par Allah"},
      {'ar': "أضغط على لساني بأسناني وأشرب جرعة ماء قبل أن أنطق بأي رد", 'en': "Press the tongue between the teeth and sip water before uttering any reply", 'fr': "Serrer la langue entre les dents et boire une gorgee d eau avant toute reponse"},
      {'ar': "أتوضأ أو أغير مكاني وأجلس إن كنت واقفا حتى يسكن الغضب", 'en': "Make wudu or change your spot and sit down if standing until the anger settles", 'fr': "Faire les ablutions ou changer de place et s asseoir si debout jusqu a ce que la colere s apaise"},
      {'ar': "أعتذر فورا وأستغفر بعد أي زلة لسان لأكسر دافع التكرار", 'en': "Apologize at once and seek forgiveness after any slip to break the urge to repeat", 'fr': "S excuser aussitot et demander pardon apres tout ecart pour briser l envie de recommencer"},
    ],
    environment: [
      {'ar': "أبتعد عن المجالس والمحادثات التي يكثر فيها السب والكلام البذيء", 'en': "Avoid gatherings and chats where cursing and foul talk are common", 'fr': "Eviter les reunions et discussions ou les insultes et le langage grossier sont frequents"},
      {'ar': "أكتم الحسابات والمقاطع التي تطبع الألفاظ النابية وأتابع محتوى نظيف اللسان", 'en': "Mute accounts and clips that normalize foul words and follow clean spoken content", 'fr': "Couper les comptes et videos qui banalisent les gros mots et suivre du contenu au langage propre"},
      {'ar': "أضع تذكيرا مرئيا قرب مكتبي ولوحة هاتفي بفضل حفظ اللسان", 'en': "Place a visible reminder near your desk and phone wallpaper about guarding the tongue", 'fr': "Placer un rappel visible pres du bureau et en fond d ecran sur garder sa langue"},
      {'ar': "أحدد كلمة بديلة متفقا عليها مع الأهل ينبهونني بها فور بدء أي لفظ سيئ", 'en': "Agree on a code word with family that they say to alert me the moment a bad word starts", 'fr': "Convenir d un mot code avec la famille qu ils disent pour m alerter des qu un gros mot commence"},
    ],
  ),
  'impulse_buying': HabitChecklists(
    competingResponses: [
      {'ar': "أؤجل أي شراء أربعا وعشرين ساعة قبل أن أقرره", 'en': "I delay any purchase for 24 hours before deciding", 'fr': "Je reporte tout achat de 24 heures avant de decider"},
      {'ar': "أكتب الحاجة في قائمة واحدة ولا أشتري إلا منها", 'en': "I write the item on a single list and buy only from it", 'fr': "J ecris l article sur une seule liste et n achete que de celle ci"},
      {'ar': "أسأل نفسي هل أملك بديلا يكفيني قبل الدفع", 'en': "I ask myself if I already own a sufficient alternative before paying", 'fr': "Je me demande si je possede deja une alternative suffisante avant de payer"},
      {'ar': "أحول مبلغ الشراء إلى صدقة أو ادخار فورا", 'en': "I move the purchase amount into charity or savings right away", 'fr': "Je transfere le montant de l achat vers une aumone ou une epargne aussitot"},
    ...
    environment: [
      {'ar': "أحذف تطبيقات التسوق وأزيل بيانات البطاقة المحفوظة", 'en': "I delete shopping apps and remove saved card details", 'fr': "Je supprime les applications d achat et les coordonnees de carte enregistrees"},
      {'ar': "ألغي الاشتراك في رسائل العروض والتنبيهات الترويجية", 'en': "I unsubscribe from sales emails and promotional alerts", 'fr': "Je me desabonne des courriels de soldes et des alertes promotionnelles"},
      {'ar': "أخرج بميزانية نقدية محددة وأترك البطاقات في البيت", 'en': "I go out with a fixed cash budget and leave cards at home", 'fr': "Je sors avec un budget liquide fixe et laisse les cartes a la maison"},
      {'ar': "أتجنب الأسواق ومواقع التسوق عند الفراغ أو الضيق", 'en': "I avoid malls and shopping sites when idle or stressed", 'fr': "J evite les centres commerciaux et sites d achat quand je m ennuie ou suis stresse"},
    ],
  ),
