  ...
  ar: {
    ...
    pages: {
      home: {
        ...
        tracks: [
          { icon: 'smokeFree', title: 'كسر عادة', desc: 'التدخين، قضم الأظافر، التسويف، الهاتف، السهر، الغضب... نتعامل معها بوعيٍ وبمنهج التدريب على عكس العادة (HRT).', href: 'break-habit' },
          { icon: 'sprout', title: 'بناء عادة جديدة', desc: 'الصلاة في وقتها، وِرد القرآن، الصلاة على النبي، بر الوالدين، الرياضة، القراءة... نثبِّت العادة الحسنة بالسلاسل والتحفيز.', href: 'build-habit' },
        ],
        features: [
          { icon: 'lock', h: 'خصوصيّةٌ كاملة', p: 'ملفّك خاصٌّ بك وحدك، لا يراه أحد. التسجيل بالاسم والبريد وكلمة المرور فقط.' },
          { icon: 'shield', h: 'دروعٌ وتحفيز', p: 'كلّما أكملت أياماً كسبت درعاً: فضّيٌّ عند ثلاثين يوماً، وذهبيٌّ عند ستّين، وماسيٌّ عند تسعين.' },
          { icon: 'moon', h: 'متوافقٌ مع قيمك', p: 'محتوًى يحثّ على الخير، مع قوالب عاداتٍ إسلاميةٍ اختيارية.' },
          { icon: 'wifiOff', h: 'يعمل دون اتصال', p: 'سجِّل يومك في أيِّ وقت، ويتزامن عند عودة الاتصال.' },
        ],
      ...
      privacy: {
        ...
        blocks: [
          ...
          { h: 'مزوّدو الخدمة', p: 'نستخدم Supabase لتخزين البيانات والمصادقة وإرسال رسائل التحقق بالبريد. وجميع الإشعارات والتذكيرات تُولّد على جهازك محلياً دون أي خدمة إشعارات خارجية. وتخضع هذه الخدمة لسياستها الخاصة، ونقتصر على الحدّ اللازم.' },
  ...
  en: {
    ...
    pages: {
      home: {
        ...
        tracks: [
          { icon: 'smokeFree', title: 'Break a habit', desc: 'Smoking, nail-biting, procrastination, phone, late nights, anger... handled with awareness and Habit Reversal Training.', href: 'break-habit' },
          { icon: 'sprout', title: 'Build a new habit', desc: 'Prayer on time, daily Qur\'an, salawat, honoring parents, exercise, reading... make the good habit stick with streaks and motivation.', href: 'build-habit' },
        ],
        features: [
          { icon: 'lock', h: 'Fully private', p: 'Your profile is yours alone. Sign up with just name, email and password.' },
          { icon: 'shield', h: 'Badges & motivation', p: 'Earn shields as you progress: silver at 30, gold at 60, diamond at 90 days.' },
          { icon: 'moon', h: 'Values-aligned', p: 'Encouraging content, with optional faith-based habit templates.' },
          { icon: 'wifiOff', h: 'Works offline', p: 'Log your day anytime; it syncs when you reconnect.' },
        ],
      ...
      privacy: {
        ...
        blocks: [
          ...
          { h: 'Service providers', p: 'We use Supabase for storage, authentication and verification emails. All notifications and reminders are generated locally on your device, with no third-party push service. That provider has its own policy, and we limit ourselves to what is necessary.' },
  ...
  fr: {
    ...
    pages: {
      home: {
        ...
        tracks: [
          { icon: 'smokeFree', title: 'Arrêter une habitude', desc: 'Tabac, ongles rongés, procrastination, téléphone, veilles tardives, colère... avec la méthode Habit Reversal Training.', href: 'break-habit' },
          { icon: 'sprout', title: 'Bâtir une habitude', desc: 'Prière à l\'heure, lecture, salawat, piété filiale, sport... ancrez la bonne habitude avec des séries et de la motivation.', href: 'build-habit' },
        ],
        features: [
          { icon: 'lock', h: 'Totalement privé', p: 'Votre profil n\'appartient qu\'à vous. Inscription avec nom, e-mail et mot de passe.' },
          { icon: 'shield', h: 'Badges & motivation', p: 'Gagnez des boucliers : argent à 30, or à 60, diamant à 90 jours.' },
          { icon: 'moon', h: 'Aligné sur vos valeurs', p: 'Un contenu encourageant, avec des modèles d\'habitudes religieuses optionnels.' },
          { icon: 'wifiOff', h: 'Fonctionne hors ligne', p: 'Enregistrez votre journée à tout moment ; synchronisation au retour du réseau.' },
        ],
      ...
      privacy: {
        ...
        blocks: [
          ...
          { h: 'Prestataires', p: 'Nous utilisons Supabase (stockage, authentification et e-mails de vérification). Toutes les notifications et rappels sont générés localement sur votre appareil, sans service de push tiers. Ce prestataire a sa propre politique et nous nous limitons au strict nécessaire.' },
