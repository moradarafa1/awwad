...
| `app_shared` | مشاركة التطبيق من الإعدادات. أُضيف في 2026-07-20: الزرّ كان موجوداً منذ الإطلاق ولا يُرسل شيئاً، فكانت خطوة الإحالة في القمع غير مقيسة أصلاً. يقيس **النيّة** لا الإتمام، لأن النظام لا يُخبر التطبيق بنتيجة ورقة المشاركة | `method: sheet\|clipboard` |
